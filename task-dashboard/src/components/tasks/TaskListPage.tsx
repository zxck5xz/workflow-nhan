    ...
    <div className="tasks-page">
      <div className="page-header">
        ...
        <div className="page-header__actions">
          <Button variant="secondary" onClick={() => setShowAddProjectModal(true)}>
            + Thêm dự án
          </Button>
          ...
          <PageHelp title="Hướng dẫn sử dụng - Công việc">
            ...
            <ul>
              <li>
                Nhấn <strong>+ Thêm công việc</strong> để tạo task mới.
              </li>
            ...
            <ul>
              <li>
                Sử dụng thanh tìm kiếm hoặc các bộ chọn để lọc theo dự án, người phụ trách, trạng
                thái, ưu tiên.
              </li>
      ...
      <div className="filter-bar">
        ...
        <select
          ...
          onChange={(e) =>
            setFilters((f) => ({ ...f, status: (e.target.value || null) as TaskStatus | null }))
          }
        >
        ...
        <select
          ...
          onChange={(e) =>
            setFilters((f) => ({ ...f, priority: (e.target.value || null) as Priority | null }))
          }
        >
      ...
      <div className="tasks-table-wrapper">
        {filteredTasks.length === 0 ? (
          <EmptyState
            ...
            description="Thêm công việc mới hoặc thay đổi bộ lọc"
          />
        ) : (
                    ...
                    <tr key={task.id} className={overdue ? 'task-row--overdue' : ''}>
                      <td>
                        <div className="task-title-cell">
                          <span className="task-title-text" onClick={() => setEditTask(task)}>
                            {task.title}
                          </span>
                          {task.tags.length > 0 && (
                      ...
                      <td>
                        <span
                          className={`deadline-text ${overdue ? 'deadline-text--overdue' : daysLeft <= 3 ? 'deadline-text--soon' : 'deadline-text--ok'}`}
                        >
                      ...
                      <td>
                        <div className="eisenhower-indicator">
                          <span className={task.eisenhower.urgent ? 'active' : ''} title="Urgent">
                            ⚡
                          </span>
                          <span
                            className={task.eisenhower.important ? 'active' : ''}
                            title="Important"
                          >
                            ⭐
                          </span>
      ...
      <ProjectModal
        ...
        onSave={(p) => {
          dispatch({ type: 'ADD_TASK_PROJECT', payload: p });
