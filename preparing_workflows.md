...
- **Tiến độ:** Giai đoạn 3 (hoàn thiện) + Backend DB Migration + Xác thực người dùng — Deployed full-stack (Vercel + Railway + Neon)
- **Ngày khởi tạo:** 2026-05-11
- **Cập nhật cuối:** 2026-05-26
...
- [x] **Xác thực người dùng và phân quyền**
  ...
  - [x] Frontend: Cập nhichtlich dataService để bao gồm token trong headers
...
- [ ] Chuyển snapshot endpoints từ JSON store sang DataStoreDB
- [ ] Kiểm tra docker-compose (backend + Postgres)
- [ ] Viết hướng dẫn hosting/deploy
